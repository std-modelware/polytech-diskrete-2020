#Во входном файле в первой строчке вводится количество вершин графа, в следующих строках написаны списки смежности (начиная с 1. номера вершин графа), если у этой вершины пустой список смежности, то напишите 0.
